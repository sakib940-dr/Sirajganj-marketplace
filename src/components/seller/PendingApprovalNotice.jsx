  ...
  return (
    <div className="flex flex-col items-center gap-3 rounded-xl border border-dashed border-border bg-card p-10 text-center">
      ...
      <p className="max-w-sm text-sm text-muted-foreground">
        {isRejected
          ? "বিস্তারিত জানতে অনুগ্রহ করে সুপার অ্যাডমিনের সাথে যোগাযোগ করুন।"
          : "সুপার অ্যাডমিন আপনার আবেদন যাচাই করছেন। অনুমোদন হলে আপনি দোকান ও পণ্য ম্যানেজ করতে পারবেন।"}
      </p>
    </div>
  );
}
